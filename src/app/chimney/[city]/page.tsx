              ...
              {nearbyCitiesWithPages.length > 0 && (
                <div className="bg-orange-50 p-6 rounded-xl">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {nearbyCitiesWithPages.slice(0, 8).map((nearbyCity) => (
                      <Link
                        ...
                        className="bg-white px-3 py-2 rounded-lg shadow-sm text-orange-800 hover:bg-orange-100 transition-colors"
                      >
                        {nearbyCity.city}
                      </Link>
                    ))}
                  ...
                  {nearbyCitiesWithPages.length > 8 && (
                    <Link
                      href="/chimney"
                      className="text-orange-800 text-sm font-medium mt-3 inline-flex items-center gap-1 hover:underline"
                    >

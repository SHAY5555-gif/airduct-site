...
const cities = [
  ...
  "Buena Park", "Laguna Niguel", "La Habra", "Westminster", "Fountain Valley",
  "Placentia", "Brea", "Stanton", "Cypress", "Aliso Viejo",
  "Dana Point", "San Juan Capistrano", "Laguna Hills", "Rancho Santa Margarita", "Seal Beach"
];
  ...
  return (
    <>
        ...
        <div className="container-custom">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
              Air Duct & Chimney Services in Orange County
            </h1>
            <p className="text-xl text-blue-100 mb-6">
              Professional air duct cleaning, chimney services, and dryer vent cleaning for homes and businesses throughout Orange County.
            </p>
            <a href={`tel:${PHONE}`} className="btn-secondary inline-block text-lg py-4 px-8">
              Call {PHONE} for Service in OC
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4">Our Services in Orange County:</h3>
            ...
            <div className="relative h-80 lg:h-[400px] rounded-xl overflow-hidden">
              <Image
                ...
                alt="Orange County neighborhood"
                fill
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Cities We Serve in Orange County</h2>
      ...
      <section className="section-padding bg-blue-900 text-white">
        <div className="container-custom text-center">
          <h2 className="text-3xl font-bold mb-4">Ready for Service in Orange County?</h2>
          <p className="text-xl text-blue-200 mb-8 max-w-2xl mx-auto">
            Call today for a free estimate. We provide fast, professional service throughout Orange County.
          </p>
          <a href={`tel:${PHONE}`} className="btn-secondary inline-block text-lg py-4 px-8">
            Call {PHONE} Now
          </a>

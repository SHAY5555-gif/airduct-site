    ...
    <>
        ...
        <div className="container-custom">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
              Air Duct Cleaning in Los Angeles, Orange, Riverside & San Bernardino Counties
            </h1>
            <p className="text-xl text-blue-100 mb-6">
              Remove dust, allergens, mold, and debris from your HVAC system for cleaner, healthier indoor air.
            </p>
      ...
      <section className="section-padding bg-blue-900 text-white">
        <div className="container-custom text-center">
          <h2 className="text-3xl font-bold mb-4">Ready for Cleaner Air?</h2>

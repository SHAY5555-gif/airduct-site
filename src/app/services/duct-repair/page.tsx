        ...
        <div className="container-custom">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
              Duct Repair Services in Southern California
            </h1>
            <p className="text-xl text-blue-100 mb-6">
              Fix leaks, damaged ductwork, and airflow issues to restore your HVAC system's efficiency.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-80 lg:h-[500px] rounded-xl overflow-hidden">
              <Image
                ...
                alt="HVAC duct inspection and repair"
                fill
